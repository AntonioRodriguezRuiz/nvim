...
local mappings = {
    L = {
        ...
        t = {
            ...
            M = { function() require('jdtls').test_nearest_method(true) end, "Test Method Debug" },
            C = { function() require('jdtls').test_class(true) end, "Test Class Debug" },
            A = { function() run_java_test_all(true) end, "All Tests Debug" }
        },
    }
}
