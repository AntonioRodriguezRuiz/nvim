...
_G.packer_plugins = {
  ...
  ["cmp-dap"] = {
    loaded = true,
    path = "/home/antonio/.local/share/nvim/site/pack/packer/start/cmp-dap",
  ...
  ["nvim-ts-rainbow2"] = {
    loaded = true,
    path = "/home/antonio/.local/share/nvim/site/pack/packer/start/nvim-ts-rainbow2",
  ...
  ["vim-bbye"] = {
    loaded = true,
    path = "/home/antonio/.local/share/nvim/site/pack/packer/start/vim-bbye",
